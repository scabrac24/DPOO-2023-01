...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de origen de un Atleta a partir de su nombre");
	...
	private void ejecutarBuscarAtletaDarPais()
	{
		System.out.println("\n" + "Nombre de un Atleta y su pais" + "\n");
		
		String nombre_atleta = input("Por favor ingrese el nombre del atleta que desea buscar");
